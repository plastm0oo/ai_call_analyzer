...
class CoachingReportRepository:
    def save_report(
        ...
        *,
        ...
        self._insert_dialog_stages(db, report_id, report_data.get("dialog_stages", []))
        self._insert_mistakes(db, report_id, report_data.get("mistakes", []))
        self._insert_recommendations(db, report_id, report_data.get("recommendations", []))

        db.commit()
        return int(report_id)

    def _insert_dialog_stages(self, db: Session, report_id: int, dialog_stages: list[dict[str, Any]]) -> None:
    ...
    def _insert_recommendations(self, db: Session, report_id: int, recommendations: list[dict[str, Any]]) -> None:
